...
import kotlinx.android.synthetic.main.activity_lab_change_attribution_info_button_color.*
...
class KotlinWorldviewSwitchActivity : AppCompatActivity() {
    ...
    private var TAG = "KotlinWorldviewSwitchActivity"
...
//                            ["match", ["get", "worldview"], ["all", "IN"], true, false]
                            ...
                            layerToBeAdjusted?.setFilter(
                                    match(
                                            get("worldview"),
                                            all(get(possibleWorldViews[index])),
